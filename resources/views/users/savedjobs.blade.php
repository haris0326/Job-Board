        ...
        <div class="row">
            <div class="col-md-7">
                ...
                <div class="custom-breadcrumbs">
                    ...
                    <a href="{{ route('job.show') }}">Job</a> <span class="mx-2 slash">/</span>
        ...
        <ul class="job-listings mb-5">
            ...
            @foreach ($savedJobs as $job)
                <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
                    <a href="{{ route('single.job', $job->job_id) }}" class="d-block w-100"></a>
                    <div class="job-listing-logo">
                        <img src="{{ asset('assets/images/' . $job->job_image) }}" alt="{{ $job->job_title }} - {{ $job->company }}" class="img-fluid">
                    </div>
